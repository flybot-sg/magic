...
(defn remote-prepl
  ...
  Alpha, subject to change."
  {:added "1.10"}
  [^String host port ^System.IO.TextReader                                                              ;;; ^Reader
  ...
  (let [valf (resolve-fn valf)
        ...
        rd (-> socket .GetStream System.IO.StreamReader. clojure.lang.LineNumberingTextReader.)         ;;; .getInputStream InputStreamReader. BufferedReader. LineNumberingPushbackReader.
        wr (-> socket .GetStream System.IO.StreamWriter.)                                               ;;; .getOutputStream OutputStreamWriter.
        EOF (Object.)]
